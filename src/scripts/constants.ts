export const SALES_ITEMS = [
  {
    title: 'O3 Shirt',
    promoDescription: 'Stay cool with this O3 machine code limited shirt.',
    description: 'A limited edition O3 shirt, made especially for DevCon 2019!',
    imageURL: require('../assets/images/tshirt.png'),
    price: '8',
    type: 'shirt',
  },
  {
